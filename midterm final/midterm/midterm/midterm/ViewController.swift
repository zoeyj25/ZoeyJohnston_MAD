...
class ViewController: UIViewController {
   ...
   // }
    ...
    ///let milesGallon = 24
        ...
        //trial
    let gallonValue = Float(gallonsLabel.text!)!
    
    let commuteTime=miles * (1/20)
    let gasPurchase = gallonValue*24
    ...
    ///doing the updating on numbers
    @IBAction func updateInfo(_ sender: Any) {
        commuteTime()
    }
    ///to do still
    //////update time when goes to month
    //// alerts
    ////segmented control affects commute time
